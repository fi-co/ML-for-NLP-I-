...
%
% input
% - trainingData_abstract    - a #examples x #voxels matrix for abstract concepts
% - trainingTargets_abstract - a #examples x #dimensions matrix for abstract concepts
% - trainingData_concrete    - a #examples x #voxels matrix for concrete concepts
% - trainingTargets_concrete - a #examples x #dimensions matrix for concrete concepts
%
% output:
% - weightMatrix_abstract - a #voxels+1 x #dimensions weight matrix for abstract concepts
% - r_abstract - #dimensions vector with the regularization parameter value for each dimension for abstract concepts
% - weightMatrix_concrete - a #voxels+1 x #dimensions weight matrix for concrete concepts
% - r_concrete - #dimensions vector with the regularization parameter value for each dimension for concrete concepts
%
% Notes:
...
function [weightMatrix_abstract, r_abstract, weightMatrix_concrete, r_concrete] = learnDecoder(trainingData_abstract, trainingTargets_abstract, trainingData_concrete, trainingTargets_concrete)

% Function to train a model for a given dataset
    function [weightMatrix, r] = trainModel(trainingData, trainingTargets)
        ...
        % of lambda. SVD is expressed as X = UDV'.
...
% Train models for abstract and concrete concepts separately
[weightMatrix_abstract, r_abstract] = trainModel(trainingData_abstract, trainingTargets_abstract);
[weightMatrix_concrete, r_concrete] = trainModel(trainingData_concrete, trainingTargets_concrete);
